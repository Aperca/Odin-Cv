function PracticalExp({ company, setCompany, position, setPosition, responsibilities, setResponsibilities, startDate, setStartDate, endDate, setEndDate, isEditing }) {
    return (
      <div className="border-b mb-44">
        ...
        <input required className="border rounded p-2 mb-3 input-style border rounded p-2 mb-3 bg-gray-100" type="text" value={company} onChange={(e) => setCompany(e.target.value)} disabled={!isEditing} />
        <label className='block mb-2' >Position Title</label>
        <input required  className="border rounded p-2 mb-3 bg-gray-100 input-style" type="text" value={position} onChange={(e) => setPosition(e.target.value)} disabled={!isEditing} />
        ...
        <input required className="border rounded p-2 mb-3 bg-gray-100 input-style" type="date" value={startDate} onChange={(e) => setStartDate(e.target.value)} disabled={!isEditing} />
