function GeneralInfo({ name, setName, email, setEmail, phone, setLocation, location, setPhone, isEditing }) {
    return (
      < div className="border-b mb-4 ">
        ...
        <input
          type="text" className='input-style border rounded p-2 mb-3 bg-gray-100 '
          value={location}
